...
class Woocommerce_Doordash_API {
	...
	public function request( $request_path, $request_args ) {
		...
		if ( ! $this->get_keys() ) {
			WCDD()->log->error( sprintf( __( 'Error performing request to %s: Missing API configuration' ), $request_path ) );
			return false;
		}
		...
		if ( $response_code !== 200 ) {
			...
			switch ( $response_code ) {
				case 400: 
					...
					wc_add_notice( __( 'DoorDash: The request was syntactically invalid', 'local-delivery-by-doordash' ), 'notice' );
					break;
				case 401: 
