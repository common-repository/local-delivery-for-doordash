...
return array(
	...
	array(
		...
		'name' => __( 'Default Pickup Instructions', 'woocomemrce-doordash' ),
		'type' => 'text',
	...
	array(
		...
		'type' => 'title',
		'css' => 'max-width: 300px',
		'desc' => __( 'Set the default hours that your shop will fulfill deliveries. These will be the default when new locations are created, if a location&rsquo;s individual hours are disabled, or if no locations have been configured.
		...
		Make sure you have configured your Timezone in your WordPress settings under <em>Settings &raquo; General</em>.
		
		If deliveries are not offered, leave the field for that day blank.', 'local-delivery-by-doordash' ),
	),
	array(
